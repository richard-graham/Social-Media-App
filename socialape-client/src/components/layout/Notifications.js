...
class Notifications extends Component {
  ...
  onMenuOpened = () => {
    let unreadNotificationsIds = this.props.notifications
      .filter((note) => !note.read) //give us arr of unread notifications
      .map((note) => note.notificationId) //returns arr of Ids of the notifications that have 'read' as false
  ...
  render(){
    ...
    return (
      <Fragment>
        ...
        <Menu 
          anchorEl={anchorEl}
          open={Boolean(anchorEl)} // if has anchorEl = true else false
